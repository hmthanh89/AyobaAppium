...
public class RestAssured_Protocol extends BaseProtocol<Response> implements IProtocol
{
	public RestAssured_Protocol() {}
	
	public RestAssured_Protocol(String sBaseURI) { 
		super(sBaseURI); 
	}
	public RestAssured_Protocol(String sBaseURI, Authentication oAuthen) { 
